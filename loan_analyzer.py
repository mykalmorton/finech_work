...
print(f"The remaining month {remaining_months}")
...
def calculate_present_value(future_loan_value, discount_rate, months_remaining):
    present_value = future_loan_value / (1 + discount_rate /100) ** months_remaining
    return present_value
# Values entered in the loan_price
present_loan_price = round(calculate_present_value(future_value, discount_rate, remaining_months),2)
print(f"The present value is ${present_loan_price}")
...
if present_loan_price >= costs:
    ...
    print("That the loan is too expensive and not worth the price")
...
# present_loan_price = round(calculate_present_value(future_value, annual_discount_rate, remaining_months),2)
# print(present_loan_price)
...
present_value = round(calculate_present_value(future_value, annual_discount_rate, remaining_months),2)
